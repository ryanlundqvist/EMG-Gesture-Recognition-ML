...
st.code("def train_rf_classifier(X_train, y_train): rf_classifier = RandomForestClassifier( n_estimators=1000, random_state=42, max_depth=None, min_samples_split=20, min_samples_leaf=10 ) rf_classifier.fit(X_train, y_train) return rf_classifier", language="python", line_numbers=False)
